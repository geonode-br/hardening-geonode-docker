# Hardening a Geonode Project

This is a sample project where changes will be made to make this stack more secure
...
**NOTE**: *You can call your geonode project whatever you like **except 'geonode'**. Follow the naming conventions for python packages (generally lower case with underscores (``_``). In the examples below, replace ``geonode_project`` with whatever you would like to name your project.*
...
1. Prepare the Environment
    ...
    mkvirtualenv --python=/usr/bin/python3 geonode_project
    pip install Django==2.2.12

    django-admin startproject --template=./geonode-project -e py,sh,md,rst,json,yml,ini,env,sample,properties -n monitoring-cron -n Dockerfile geonode_project
